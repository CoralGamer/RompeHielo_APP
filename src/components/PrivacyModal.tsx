...
export default function PrivacyModal({ isOpen, onClose }: PrivacyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Box */}
      <div className="relative w-full max-w-xl max-h-[85vh] glass-panel rounded-3xl z-10 shadow-2xl border border-outline-variant/40 animate-in fade-in zoom-in-95 duration-300 flex flex-col text-left overflow-hidden">
