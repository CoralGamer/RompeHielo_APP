...
export default function WelcomeModal({ isOpen, onClose }: WelcomeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto glass-panel rounded-3xl p-6 md:p-8 z-10 shadow-2xl border border-outline-variant/40 animate-in fade-in zoom-in-95 duration-300 flex flex-col text-left">
